        ...
        parseHeatmapData: function(features) {
            ...
            if (features) {
                ...
                for (i = 0; i < features.length; i++) {
					...
					console.log("Sega spatialReference e "+ this.get("map").spatialReference);
                    var pointESRI = new Point(geo.x, geo.y, map.spatialReference);
                    console.log(pointESRI);
                    var mp = webMercatorUtils.geographicToWebMercator(pointESRI);
                    console.log(mp);

                    dataPoint = new Point({ "x": mp.x, "y": mp.y, "spatialReference": map.spatialReference });
